...
Reference document for the Regulatory & Compliance Capability Development line ($18,000, Feb 2026–Jul 2027). Tracks firms engaged, their proposals, and the NZ compliance landscape as it applies to this project across the R&D timeline.

Related task: [[rd-20260415-002]] | Parent dashboard: [[nexwave-rd]]
...
| **MBIE grant obligations** | Conditions in the CONT-109091-N2RD-NSIWKC funding agreement governing use of grant funds, eligible costs, IP, publicity, co-funding, change of control | Already live; affects tool design decisions (NZ-only R&D, IP ownership, reporting) |
...
| **HDC Code of Rights** | Health and Disability Commissioner Code giving patients rights over their health care | Applies when the tool is used in a clinical setting. Design must support GPs in meeting obligations (e.g. right to information, informed consent) |
...
| **PHO / Health NZ contract obligations** | GP practices contract with PHOs who contract with Health NZ. Back-to-back clauses can impose technical and security requirements on tools used within practices | NexWave tools will operate inside PHO-contracted practices; these obligations flow through |
...
| **ALEX FHIR API licence terms** | Medtech's licence governing access to the ALEX integration layer | Constraints on what data can be extracted, stored, or processed. Buddle Findlay flagged this as needing formal review |
...
| **IP protection** | Copyright, contractual, and trade secret protections for the tool's code, models, and training data | Buddle Findlay flagged: worth addressing before sharing extensively with third parties |
...
Your instinct is right: brief overview now, deeper reviews as the project progresses, formal assessment when the time comes.

**Now (Obj 1, synthetic data):**
Commission Bell Gully Phase 1 ($2,500–$4,000). The SaMD classification answer is the single most important question and it controls everything downstream. You do not need the full Buddle Findlay overview yet — you already have the landscape from their proposal. What you don't have is the classification determination.

**Before Obj 2 (real patient data):**
Draft a PIA internally. Both firms confirmed you're well-placed to do this. Budget a brief legal review of the PIA ($1,000–$2,000) before submitting to any Health NZ or PHO integration partner.
...
Different layer — computer science and SaMD technical pathway (IEC 62304, ISO 13485, verification and validation). Not a replacement for legal advice; complements it. Worth engaging once she returns.
